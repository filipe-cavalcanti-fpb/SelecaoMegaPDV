 ...
 * @author assert
 */
public class GroupHasAdministeredByUserBean extends AbstractBeanObject{
    private int fkIdUser;
    private int fkIdGroup;

    public GroupHasAdministeredByUserBean(int fkIdUser, int fkIdGroup) {
        this.fkIdUser = fkIdUser;
        this.fkIdGroup = fkIdGroup;
    }
    
    public GroupHasAdministeredByUserBean(){
